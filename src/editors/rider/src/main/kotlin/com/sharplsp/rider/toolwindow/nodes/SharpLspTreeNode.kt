...
/**
 * Base contract for every node in the SharpLsp Solution tree.
 *
 * Nodes own their own:
...
interface SharpLspTreeNode {
     ...
     */
    fun loadChildren(project: Project, callback: (List<SharpLspTreeNode>) -> Unit)
