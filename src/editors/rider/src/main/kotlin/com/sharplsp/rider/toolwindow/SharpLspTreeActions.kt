...
import com.sharplsp.rider.toolwindow.nodes.DependenciesNode
import com.sharplsp.rider.toolwindow.nodes.LspBridge
import com.sharplsp.rider.toolwindow.nodes.NuGetPackageNode
import com.sharplsp.rider.toolwindow.nodes.ProjectReferenceNode
import com.sharplsp.rider.toolwindow.nodes.ProjectTreeNode
 ...
 */
internal object SharpLspTreeActions {
...
private class InstallNuGetAction(
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        com.sharplsp.rider.toolwindow.nuget.SharpLspNuGetBrowserDialog(project, projectPath).show()
    }
}
