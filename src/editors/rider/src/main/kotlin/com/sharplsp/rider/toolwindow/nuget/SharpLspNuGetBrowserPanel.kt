...
import com.sharplsp.rider.lsp.NuGetInstallParams
import com.sharplsp.rider.lsp.NuGetInstalledParams
import com.sharplsp.rider.lsp.NuGetSearchParams
import com.sharplsp.rider.lsp.NuGetTarget
import com.sharplsp.rider.lsp.NuGetTargetsParams
import com.sharplsp.rider.lsp.NuGetUninstallParams
import com.sharplsp.rider.lsp.PackageInfo
import com.sharplsp.rider.toolwindow.nodes.LspBridge
...
/**
 * Main UI for the SharpLsp NuGet browser. Visual parity with the VS Code
 ...
 */
class SharpLspNuGetBrowserPanel(
...
/**
 * Dialog wrapper around [SharpLspNuGetBrowserPanel] for the right-click
 * "Install NuGet Package…" action. Pre-selects the clicked project.
 */
class SharpLspNuGetBrowserDialog(
    project: Project,
    initialProjectPath: String,
) : com.intellij.openapi.ui.DialogWrapper(project, true) {
    private val panel = SharpLspNuGetBrowserPanel(project, initialProjectPath)
