...
我们正在构建 Forge — 一个开源的、编辑器无关的 C# 和 F# 语言服务器。
...
Forge 是一个单一的 LSP 服务器，为每款编辑器提供完整的 .NET 开发体验。用 Rust 构建以追求速度，由 Roslyn 和 FSharp.Compiler.Service 驱动以确保准确性。
...
Forge 是开源的。查看 [GitHub 仓库](https://github.com/MelbourneDeveloper/forge)，加入我们，共同构建开发者应得的 .NET 工具链。
