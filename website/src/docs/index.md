...
<section class="callout">
  ...
  <ul class="requirement-list">
    <li><span class="requirement-icon" aria-hidden="true">.NET</span><div><h3>.NET 10.0 SDK</h3><p>Required for project parsing and MSBuild integration. Ensure <code>dotnet</code> is on your PATH.</p></div></li>
  </ul>
</section>
