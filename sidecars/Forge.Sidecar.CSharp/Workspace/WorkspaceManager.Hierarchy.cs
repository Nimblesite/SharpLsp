using CallHierarchyItemResult = Outcome.Result<Forge.Sidecar.CSharp.CallHierarchyItem?, string>;
using CallHierarchyListResult = Outcome.Result<
    System.Collections.Generic.List<Forge.Sidecar.CSharp.CallHierarchyCallResult>,
    string
>;
using TypeHierarchyItemResult = Outcome.Result<Forge.Sidecar.CSharp.TypeHierarchyItem?, string>;
using TypeHierarchyListResult = Outcome.Result<
    System.Collections.Generic.List<Forge.Sidecar.CSharp.TypeHierarchyItem>,
    string
>;
