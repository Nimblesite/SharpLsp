using CodeLensesResult = Outcome.Result<
    System.Collections.Generic.List<Forge.Sidecar.CSharp.CodeLensResult>,
    string
>;
using FormattingResult = Outcome.Result<
    System.Collections.Generic.List<Forge.Sidecar.CSharp.TextEditResult>,
    string
>;
using InlayHintsResult = Outcome.Result<
    System.Collections.Generic.List<Forge.Sidecar.CSharp.InlayHintResult>,
    string
>;
using SemanticTokensResultType = Outcome.Result<Forge.Sidecar.CSharp.SemanticTokensResult, string>;
