...
1. Search [Google Trends](https://trends.google.com/home) for trending keywords related to ".NET LSP", "C# language server", "F# development", "VS Code C# extension", "open source .NET IDE".
...
2. CSS classes follow naming conventions (name classes after what the element IS, not what section it's in)
